    ...
    components: {
      ...
      schemas: {
        ...
        SignUpRequest: {
          ...
          properties: {
            ...
            username: {
              ...
              description: 'Optional username (3-30 chars, alphanumeric, underscores, hyphens). If not provided, one will be auto-generated.',
              example: 'johndoe',
            },
          },
        },
        ...
        Message: {
          ...
          properties: {
            id: { type: 'integer', example: 1 },
            conversation_id: { type: 'integer', example: 5 },
            sender_id: { type: 'integer', example: 2 },
            content: { type: 'string', example: 'Hello, how are you?' },
            attachment_url: { type: 'string', nullable: true, format: 'uri' },
            attachment_type: { type: 'string', nullable: true, enum: ['image', 'document', 'video', 'audio'] },
            attachment_name: { type: 'string', nullable: true },
            forwarded_from_message_id: { type: 'integer', nullable: true },
            edited_at: { type: 'string', nullable: true, format: 'date-time' },
            deleted_at: { type: 'string', nullable: true, format: 'date-time' },
            is_read: { type: 'boolean', example: false },
            read_at: { type: 'string', nullable: true, format: 'date-time' },
            delivered_at: { type: 'string', nullable: true, format: 'date-time' },
            delivery_status: { type: 'string', enum: ['sent', 'delivered', 'read'], example: 'sent' },
            created_at: { type: 'string', format: 'date-time' },
            first_name: { type: 'string', example: 'John' },
            last_name: { type: 'string', example: 'Doe' },
            profile_image_url: { type: 'string', nullable: true },
        ...
        Conversation: {
          ...
          properties: {
            ...
            participant1_id: { type: 'integer', example: 1 },
            participant2_id: { type: 'integer', example: 2 },
            last_message_at: { type: 'string', nullable: true, format: 'date-time' },
            last_message_id: { type: 'integer', nullable: true },
            last_message_content: { type: 'string', nullable: true },
            participant1_unread_count: { type: 'integer', example: 0 },
            participant2_unread_count: { type: 'integer', example: 3 },
            unread_count: { type: 'integer', example: 3 },
            created_at: { type: 'string', format: 'date-time' },
            updated_at: { type: 'string', format: 'date-time' },
            other_user_id: { type: 'integer', example: 2 },
            other_user_first_name: { type: 'string', example: 'Jane' },
            other_user_last_name: { type: 'string', example: 'Smith' },
            other_user_profile_image: { type: 'string', nullable: true },
            other_user: {
              type: 'object',
              nullable: true,
              properties: {
                ...
                last_seen_at: { type: 'string', nullable: true, format: 'date-time' },
              },
            },
          },
        },
        MessageReaction: {
          type: 'object',
          properties: {
            reaction_type: { type: 'string', example: '👍' },
